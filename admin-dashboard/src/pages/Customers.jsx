  ...
  useEffect(() => {
    const getCustomers = async () => {
      try {
        ...
        // Filter out admins from the customers list
        const filteredCustomers = res.data.filter((user) => !user.isAdmin);
      ...
      <main className="p-4 md:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-8">
          {loading ? (
            ...
            <div className="col-span-full text-center py-20 text-black/40 font-sofia-pro">
              No customers found.
            </div>
          ) : (
            customers.map((customer) => (
              <div
                key={customer._id}
                className="bg-white border border-gray-100 p-8 rounded-sm hover:shadow-xl hover:shadow-black/5 transition-all group"
              >
                ...
                <h3 className="text-[18px] font-bold text-black font-gt-walsheim mb-1">
                  {customer.username}
                </h3>
                <span className="text-[10px] font-bold uppercase tracking-widest font-sofia-pro text-green-500">
                  Customer
                </span>
                ...
                <div className="mt-8 pt-8 border-t border-gray-50 flex justify-between">
                  <div>
                    <p className="text-[10px] uppercase tracking-widest text-black/40 font-bold font-sofia-pro">
                      Joined
                    </p>
