  ...
  if (!user)
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] font-sofia-pro">
        ...
        <a
          href="/login"
          className="px-8 py-3 bg-black text-white uppercase tracking-widest font-bold text-sm"
        >
          Login
        </a>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full mt-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-2">
            <h2 className="text-[32px] font-bold text-black mb-10 font-gt-walsheim">
            ...
            {loading ? (
              ...
              <p className="text-black/40 font-sofia-pro">
              ...
              <div className="flex flex-col gap-6">
                {orders.map((order) => (
                  <div
                    key={order._id}
                    className="border border-gray-100 rounded-sm overflow-hidden bg-[#FCFCFC]"
                  >
                    <div
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-[14px] font-bold text-black font-sofia-pro">
                            Commande #{order._id.slice(-6)}
                          </p>
                          <p className="text-[12px] text-black/40 font-sofia-pro">
                      ...
                      <div className="flex items-center gap-8">
                        <div className="hidden md:block">
                          <p className="text-[11px] uppercase tracking-widest text-black/40 font-bold font-sofia-pro">
                            Statut
                          </p>
                          <p
                            className={`text-[13px] font-bold font-sofia-pro uppercase ${
                        ...
                        <div>
                          ...
                          <p className="text-[14px] font-bold text-black font-gt-walsheim">
                    ...
                    {expandedOrder === order._id && (
                      <div className="p-6 bg-white border-t border-gray-100 animate-fadeIn">
                        <h4 className="text-[13px] font-bold uppercase tracking-widest text-black mb-4 font-sofia-pro">
                          Produits commandés
                        </h4>
                        <div className="flex flex-col gap-4">
                          {order.products.map((p, idx) => (
                            <div
                              key={idx}
                              className="flex flex-col gap-4 pb-4 border-b border-gray-50 last:border-none"
                            >
                              <div className="flex justify-between items-center">
                                <span className="text-[14px] font-sofia-pro text-black/60">
                              ...
                              {reviewData.productId === p.productId && (
                                <form
                                  onSubmit={(e) =>
                                    handleProductReview(e, p.productId)
                                  }
                                  className="bg-gray-50 p-6 rounded-sm mt-2"
                                >
                                  <div className="flex items-center gap-4 mb-4">
                                    <span className="text-[12px] font-bold uppercase font-sofia-pro">
                                      Note :
                                    </span>
          ...
          <div className="bg-[#FCFCFC] p-8 border border-gray-50 rounded-sm self-start">
            <h3 className="text-[24px] font-bold text-black mb-6 font-gt-walsheim">
              Votre avis compte
            </h3>
            <p className="text-[14px] text-black/60 font-sofia-pro mb-8 leading-relaxed">
              Comment s'est passée votre expérience sur Hubrobe ? Donnez-nous
              votre avis sur notre site et nos services.
            </p>

            <form onSubmit={handleSiteReview} className="flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                <label className="text-[11px] font-bold uppercase tracking-widest text-black font-sofia-pro">
                  Note globale
                </label>
                <div className="flex gap-2">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <FiStar
                      ...
                      onClick={() =>
                        setSiteReview({ ...siteReview, rating: star })
                      }
                    />
                  ))}
                </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setSiteReview({ ...siteReview, comment: e.target.value })
                  }
                />
              </div>
              <button
